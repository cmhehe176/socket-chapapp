...
public class Client extends javax.swing.JFrame {
     ...
     */
    public Client(List<String> onl , int ind) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jComboBox1.getSelectedIndex()==0){
            try {
                write("send-to-global"+","+messageContent+","+onlineList.get(this.id));
            ...
            try {
                ...
                //System.out.println(parner[0] + " parner ");
                
                write("send-to-person"+","+messageContent+","+this.id+","+onlineList.get(this.id) +"," + parner[1]);
                jTextArea1.setText(jTextArea1.getText()+"Bạn (tới  "+parner[0]+"): "+messageContent+"\n");
    ...
    private void setUpSocket(List<String> onl) {
        try {
            thread = new Thread() {
                @Override
                public void run() {
                        ...
                        while (true) {
                            ...
                            if (messageSplit[0].equals("update-online-list")) {
                                ...
                                for(int i=0; i<onl.size(); i++){
                                    ...
                                    onlineList.add(onl.get(i));
                                    online+= onl.get(i) + " đang online\n";
...
//                    socketOfClient.close();
    ...
    private void updateCombobox(List<String> onl){
        jComboBox1.removeAllItems();
        jComboBox1.addItem("Gửi tất cả");
        
        String idString = ""+onl.get(index);
        for(String e : onl){
            if(!e.equals(idString)){
                jComboBox1.addItem(e + " " + onl.indexOf(e));
            }
        }
        
    }
    private void setIDTitle(List<String> onl){
        this.setTitle(onl.get(index));
    }
